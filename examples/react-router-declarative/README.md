...
Based on the Vite React + TypeScript starter, with [React Router declarative mode](https://reactrouter.com/start/declarative/installation).
...
```sh
npx gitpick keycloakify/oidc-spa/tree/main/examples/react-router-declarative start-oidc
cd start-oidc
npm install
npm run dev
```
